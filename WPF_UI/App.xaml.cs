    ...
    private static readonly IHost _host = Host.CreateDefaultBuilder()
        ...
        .ConfigureServices(
            (context, services) =>
            {
                ...
                _ = services.AddSingleton<NavigateService>();
                ...
                _ = services.AddSingleton(typeof(IRegisterProvider<>), typeof(RegisterService<>));
                _ = services.AddSingleton(typeof(ILoginProvider<>), typeof(LoginService<>));
                _ = services.AddSingleton(typeof(ICharacterProvider<>), typeof(CharacterService<>));
                ...
                _ = services.AddSingleton<ViewModels.RegisterViewModel>();
                _ = services.AddSingleton<Views.Pages.RegisterPage>();
